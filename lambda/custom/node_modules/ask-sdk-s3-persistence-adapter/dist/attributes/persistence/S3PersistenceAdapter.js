...
var S3PersistenceAdapter = /** @class */ (function () {
    ...
    S3PersistenceAdapter.prototype.deleteAttributes = function (requestEnvelope) {
        return __awaiter(this, void 0, void 0, function () {
            var objectId, deleteParams, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        objectId = path.join(this.pathPrefix, this.objectKeyGenerator(requestEnvelope));
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.s3Client.deleteObject(deleteParams).promise()];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        err_3 = _a.sent();
                        throw ask_sdk_core_1.createAskSdkError(this.constructor.name, "Could not delete item (" + objectId + ") from bucket (" + deleteParams.Bucket + "): " + err_3.message);
                    case 4: return [2 /*return*/];
                }
            });
        });
